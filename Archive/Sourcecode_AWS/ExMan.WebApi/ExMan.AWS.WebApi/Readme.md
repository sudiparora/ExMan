...
Once you have edited your template and code you can use the following command lines to deploy your application from the command line (these examples assume the project name is *ExMan.AWS.WebApi*):
...
Execute unit tests
```
    cd "ExMan.AWS.WebApi/test/ExMan.AWS.WebApi.Tests"
    dotnet test
```

Deploy application
```
    cd "ExMan.AWS.WebApi/src/ExMan.AWS.WebApi"
